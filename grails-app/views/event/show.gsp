	...
	<body>
		...
		<div id="show-event" class="content scaffold-show" role="main">
			...
			<ol class="property-list event">
				...
				<g:if test="${eventInstance?.position}">
				<li class="fieldcontain">
					<span id="position-label" class="property-label"><g:message code="event.position.label" default="Position" /></span>
					
						<span class="property-value" aria-labelledby="position-label"><g:fieldValue bean="${eventInstance}" field="position"/></span>
