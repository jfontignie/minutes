			...
			<table>
				<thead>
					<tr>
                        ...
                        <g:sortableColumn property="position" title="${message(code: 'event.position.label', default: 'Position')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${eventInstance.id}">${fieldValue(bean: eventInstance, field: "position")}</g:link></td>
